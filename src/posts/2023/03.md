...
新人从0到1编程自学入门经典[《微信小游戏开发》](https://item.jd.com/10070363837259.html)全套书籍已经在京东、当当上架，需要签名版及1v1辅导的读者请与作者联系。作者博客：[艺述论](https://yishulun.com/)。

## 补充

补充一个代码示例1相关的小示例：

[https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=b12d2b900b72fb83649868f43e3180ab](https://link.zhihu.com/?target=https%3A//play.rust-lang.org/%3Fversion%3Dstable%26mode%3Ddebug%26edition%3D2021%26gist%3Db58e70279202879562d6798723855c7b)

Thing实现了Copy语义，这里发生了Copy，变量a和b都是栈上分配的。 如果把第一行宏属性注释掉，让代码发生Move，a将被屏蔽，不能被访问
...
*（因为栈处理起来比较快）在Rust中所有值默认都会被分配到栈上，通过创建一个Box<T>容器，值可以被装箱，将原本应该分配在栈上的值分配到堆上。*

理论上编译期可以确定大小的值，都会被放在堆上，包括Rust提供的原生类型，例如字符、数组、元组tuple等，以及开发者自定义的固定大小的结构体struct、枚举enum等。