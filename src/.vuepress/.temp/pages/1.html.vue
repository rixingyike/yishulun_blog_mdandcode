...
"#动作、神情、语气从哪里来">动作、神情、语气从哪里来？</router-link></li></ul></li><li><router-link to="#大师安于用-说-与-道-有时候用用也无妨">大师安于用“说”与“道”，有时候用用也无妨</router-link><ul><li><router-link to="#将发言的角色放在中间">将发言的角色放在中间</router-link></li><li><router-link to="#不超过-10-个字的两人简单直白对话-什么也不加">不超过 10 个字的两人简单直白对话，什么也不加</router-link></li></ul></li><li><router-link to="#多角色对话-加上称谓">多角色对话，加上称谓</router-link></li><li><router-link to="#塑造角色独特的气质-个性、语言风格">塑造角色独特的气质（个性、语言风格）</router-link></li><li><router-link to="#一句话分两部分-第一部分结尾用什么标点">一句话分两部分，第一部分结尾用什么标点？</router-link></li><li><router-link to="#话说一半-剩余部分用其它代替-或让读者猜">话说一半，剩余部分用其它代替，或让读者猜</router-link></li><li><router-link to="#重音-只留重点-重音-其余删掉">重音：只留重点（重音），其余删掉</router-link></li><li><router-link to="#重复单句">重复单句</router-link></li><li><router-link to="#切换角色-话先行">切换角色，话先行</router-link></li><li><router-link to="#少用-道-只用-说">少用“道”，只用“说”</router-link></li><li><router-link to="#对话内容长-怎么办">对话内容长，怎么办？</router-link></li><li><router-link to="#回顾">回顾</router-link></li></ul></nav>
...
<p>什么是神情描写？</p>
<p>例如眉宇间透出几分不屑等。</p>
<h3 id="动作、神情、语气从哪里来" tabindex="-1"><a class="header-anchor" href="#动作、神情、语气从哪里来"><span>动作、神情、语气从哪里来？</span></a></h3>
...
<h2 id="大师安于用-说-与-道-有时候用用也无妨" tabindex="-1"><a class="header-anchor" href="#大师安于用-说-与-道-有时候用用也无妨"><span>大师安于用“说”与“道”，有时候用用也无妨</span></a></h2>
<p>“写网文如何避免 xx 说，和 xx 道呢？”</p>
<p>面对题主的疑问，我表示嗤之以鼻：“你干嘛避免，金庸古龙王小波，莫言鲁迅，哪个不是能‘说’会‘道’的？”</p>
<h3 id="将发言的角色放在中间" tabindex="-1"><a class="header-anchor" href="#将发言的角色放在中间"><span>将发言的角色放在中间</span></a></h3>
<p>“可是……”题主面露难色，“现在的人看得都烦了呀！”</p>
<h3 id="不超过-10-个字的两人简单直白对话-什么也不加" tabindex="-1"><a class="header-anchor" href="#不超过-10-个字的两人简单直白对话-什么也不加"><span>不超过 10 个字的两人简单直白对话，什么也不加</span></a></h3>
<p>“那好办！”</p>
<p>“咋办？”</p>
<p>“直接像咱们现在这样，只写对话内容，不写人物不就完事儿了？”</p>
<h2 id="多角色对话-加上称谓" tabindex="-1"><a class="header-anchor" href="#多角色对话-加上称谓"><span>多角色对话，加上称谓</span></a></h2>
...
<h2 id="塑造角色独特的气质-个性、语言风格" tabindex="-1"><a class="header-anchor" href="#塑造角色独特的气质-个性、语言风格"><span>塑造角色独特的气质（个性、语言风格）</span></a></h2>
