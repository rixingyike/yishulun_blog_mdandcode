...
<h2 id="_1-itemrenderer的花屏问题" tabindex="-1"><a class="header-anchor" href="#_1-itemrenderer的花屏问题"><span>1，ITEMRENDERER的花屏问题</span></a></h2>
...
<h3 id="_1-修改策划" tabindex="-1"><a class="header-anchor" href="#_1-修改策划"><span>1) 修改策划</span></a></h3>
...
<div class="language-js line-numbers-mode" data-ext="js" data-title="js"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">list</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">itemRenderer</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> =</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> new</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> ClassFactory</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">YourItemRenderer</span><span style="--shiki-light:#999999;--shiki-dark:#666666">);</span></span></code></pre>
...
<h2 id="_2-4-电子白板问题简略" tabindex="-1"><a class="header-anchor" href="#_2-4-电子白板问题简略"><span>2-4，电子白板问题简略</span></a></h2>
...
<h2 id="_5-flash的置顶问题" tabindex="-1"><a class="header-anchor" href="#_5-flash的置顶问题"><span>5，FLASH的置顶问题</span></a></h2>
<p>默认情况下，在网页中swf对象之上放置不了浮动层，解决方案是修改FlashVars属性值，把wmode修改为opaque，同时对照其它对象，排列z-index。</p>
<h2 id="_6-聊天表情無法复制粘贴-由于聊天表情是动态文本-所以添加到textflow中的是一个sprite对象" tabindex="-1"><a class="header-anchor" href="#_6-聊天表情無法复制粘贴-由于聊天表情是动态文本-所以添加到textflow中的是一个sprite对象"><span>6，聊天表情無法复制粘贴，由于聊天表情是动态文本，所以添加到TEXTFLOW中的是一个SPRITE对象</span></a></h2>
...
<h2 id="_7-老板模式-当系统焦点离开air程序后-无法检测到系统的key-down事件" tabindex="-1"><a class="header-anchor" href="#_7-老板模式-当系统焦点离开air程序后-无法检测到系统的key-down事件"><span>7，老板模式，当系统焦点离开AIR程序后，无法检测到系统的KEY_DOWN事件</span></a></h2>
...
<h2 id="_8-air注册表操作-登陆启动look程序" tabindex="-1"><a class="header-anchor" href="#_8-air注册表操作-登陆启动look程序"><span>8，AIR注册表操作(登陆启动LOOK程序)</span></a></h2>
