...
<p>目录</p>
<nav class="table-of-contents"><ul><li><router-link to="#_1-as3事件机制的主要成员">1，AS3事件机制的主要成员</router-link></li><li><router-link to="#_2-观察者模式">2，观察者模式</router-link></li><li><router-link to="#_3-显示列表中事件流的三个阶段">3，显示列表中事件流的三个阶段</router-link></li><li><router-link to="#_4-ieventdispatcher接口讲解">4，IEventDispatcher接口讲解</router-link></li><li><router-link to="#_5-event类实例化讲解">5，Event类实例化讲解</router-link></li><li><router-link to="#_6-mouseevent事件">6，MouseEvent事件</router-link></li><li><router-link to="#_7-flash-player内部对事件的强力支持">7，Flash Player内部对事件的强力支持</router-link></li><li><router-link to="#_8-事件与代的概念">8，事件与代的概念</router-link></li><li><router-link to="#_9-为什么要有事件流三阶段">9，为什么要有事件流三阶段？</router-link></li><li><router-link to="#_10-优化程序性能的第一准则">10，优化程序性能的第一准则</router-link></li><li><router-link to="#_11-停止冒泡事情的派发">11，停止冒泡事情的派发</router-link></li></ul></nav>
