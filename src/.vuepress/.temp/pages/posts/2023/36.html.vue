...
<p><img src="@source/posts/2023/assets/F-jfFBJWAAAoHwP.jpeg" alt="MyGPT"></p>
<p>在创建过程中，我将一个 34 号 md 文件传给了它，然后，它在学习和吸收之后，给我返回了这样一段虎狼之词：</p>
<blockquote>
<p>文件 34.md 的内容主要围绕网文创作的剧情、结构、节奏和爽点进行讨论，提供了深入的分析和具体的建议。它包含了如何构建引人入胜的故事剧情、有效的结构布局、合适的故事节奏以及如何创造吸引读者的“爽点”。这些内容对于塑造鲜活的网络文学作品非常关键。特别是关于如何在保持故事连贯性的同时，制造高潮和反转点，以及如何在故事中巧妙地设置和解决冲突，这些都是关键的创作技巧。通过这些方法，我们可以打造出既有深度又富有吸引力的故事，让读者深陷其中，乐在其中。</p>
</blockquote>
...
<p>在注册的时候，有一项手机号验证，注意大陆及香港的手机号都不能使用，因为傲娇的 ChatGPT 未对我们开放。解决办法很简单，在网站（https://sms-activate.org）上购买一个临时验证码即可。Google Voice 号码在这里都不好使，因为它是虚拟号码。好在这里只是使用临时号码做一下注册验证，帐号资料中可以写另一个号码（这个号码随意），并且此后登录也不需要验证，所以临时在 sms-activate.org 网站上购买一次性的验证码服务就可以满足需求了。</p>
...
<p><img src="@source/posts/2023/assets/efb466c410f6afb3cdbf37a90fbfc6c.png" alt="My GPTs"></p>
<p>第一步，选择创建按钮。</p>
<p>第二步，开始创建。</p>
...
<p><img src="@source/posts/2023/assets/image-20231110223101946.png" alt="configure"></p>
<p>第四步，设置起始提示语。</p>
<p>在 Configure 页面还可以设置起始提示，例如下面截图中贴近下方输入框的那 4 句便是。</p>
<p><img src="@source/posts/2023/assets/image-20231110223447314.png" alt="起始提示语"></p>
<p>在 Configure 页面，有一个 Actions 设置，这是对外部第三方服务的调用设置，可以调用自己的网站 API。它并不是预置的提示，如果设置预置提示，在前面的起始提示处设置。</p>
<p><img src="@source/posts/2023/assets/image-20231110223617423.png" alt="Actions"></p>
<p>第五步，上传文件。</p>
<p>可以在 Configure 页面上传，也可以互动输入框上传。我是在输入框上传的，上传的同时又输入了一些提示，要求 ChatGPT 学习和理解这些十分重要的文件。</p>
<p><img src="@source/posts/2023/assets/image-20231110223905299.png" alt="知识文件"></p>
<p>第六步，测试与预览。</p>
<p>整个创建 GPT 的页面分为左右两个区域，前面我们一直在左面这个区域操作，现在 GPT 的创建基本完成了，我们可以在右面这个区域测试和预览它的功能表现了。</p>
<p><img src="@source/posts/2023/assets/image-20231110224231228.png" alt="Story Weaver"></p>
<p>第七步，保存。</p>
<p>更新按钮在右上角，在保存时，可以保存为私有、获得链接者可用或公开。这个范围选项，包含前面的 GPT 的 Configure 设置，都不是一次性的，过后都可以重新编辑。</p>
<p><img src="@source/posts/2023/assets/image-20231110224506012.png" alt="保存"></p>
