...
<p>最近<code v-pre>git push</code>指令又不能工作了，马上测了一下IP，发现github.global.ssl.fastly.net这个域名，除了台湾宝岛那里，基本都不能访问。（注：测试地址<a href="https://ping.chinaz.com/github.global.ssl.fastly.net%EF%BC%89" target="_blank" rel="noopener noreferrer">https://ping.chinaz.com/github.global.ssl.fastly.net）</a></p>
<figure><img src="@source/posts/2022/assets/image-20221222105336458.png" alt="image-20221222105336458" tabindex="0" loading="lazy"><figcaption>image-20221222105336458</figcaption></figure>
