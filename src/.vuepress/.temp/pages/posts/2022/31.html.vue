<template><div><h1 id="只有一个程序员开发和运营-builtwith网站年入1400万美元是怎么做到的" tabindex="-1"><a class="header-anchor" href="#只有一个程序员开发和运营-builtwith网站年入1400万美元是怎么做到的"><span>只有一个程序员开发和运营，BuiltWith网站年入1400万美元是怎么做到的？</span></a></h1>
<p><img src="@source/posts/2022/assets/builtwith.png" alt="Gary Brewer和他的BuiltWith公司"></p>
...
<h2 id="逆向思维-建立企业技术信息数据库" tabindex="-1"><a class="header-anchor" href="#逆向思维-建立企业技术信息数据库"><span>逆向思维，建立企业技术信息数据库</span></a></h2>
...
<blockquote>
<p>源码里有一段 Java 特有的代码，可以推断出该网站是用 Java 建立的……
...
<h2 id="与aboutus合作开始飞起" tabindex="-1"><a class="header-anchor" href="#与aboutus合作开始飞起"><span>与AboutUs合作开始飞起</span></a></h2>
<p>不过，对 BuiltWith 来说最重要的转折点在于 Gary Brewer 和 AboutUs 创始人 Raymond King 的会面。AboutUs 是一个包含数百万企业信息的互联网域名目录。</p>
<p>在 Gary Brewer 向 Raymond King 展示了 BuiltWith 的功能后，Raymond King 便立即同意在 AboutUs 索引中的每条记录都添加一个 BuiltWith.com 链接，以提供每个网站所使用的确切技术作为参考。</p>
<p>结果可想而知，AboutUs 包含数百万个企业信息，其每条索引都能链接到 BuiltWith.com——BuiltWith 的流量呈爆炸式增长，SEO 排名也迅速上升。</p>
...
<p>由于 BuiltWith 功能的特点，实际上企业在进入 BuiltWith.com 前，是否要为其付费就已经是一件既定的事情了，无需多加推销：要么有目的性地成为高级付费用户，挖掘更多潜在客户；要么就坚决“白嫖”，只需知道竞争对手在用什么技术即可。</p>
...
<h2 id="启示" tabindex="-1"><a class="header-anchor" href="#启示"><span>启示</span></a></h2>
