...
<h2 id="_2-golang-org-x类库无法下载的问题" tabindex="-1"><a class="header-anchor" href="#_2-golang-org-x类库无法下载的问题"><span><strong>2，golang.org/x类库无法下载的问题</strong></span></a></h2>
<p>这是一个读者遇到的问题：</p>
<blockquote>
...
<p>启动服务后，访问http://localhost:4000/hi，有读者遇到这样的错误：</p>
...
<p>1）去https://cygwin.com/install.html，下载setup-x86_64.exe</p>
...
<p><img src="@source/posts/2018/assets/21928.jpeg" alt="0"></p>
<p>往后就一路默认安装。</p>
<p>完成安装后，在终端内输入gcc，会看到有内容输出。</p>
<p>至于下载时选择哪个镜像地址：</p>
<p><img src="@source/posts/2018/assets/21931.png" alt="0"></p>
<p>一般选择前面的，下载会比较快。</p>
<p>gcc安装后，在git bash里再次执行debug.sh（sh文件在windows系统的git bash里也是认的）。输出像这个样子：</p>
<p><img src="@source/posts/2018/assets/21934.jpeg" alt="0"></p>
<p>浏览器访问http://localhost:4000/hi，是这样的：</p>
<p><img src="@source/posts/2018/assets/21938.png" alt="0"></p>
...
<p><img src="@source/posts/2018/assets/21945.png" alt="0"></p>
<p>如果是win7 32位系统，按照上面的方法安装，可能会出现以下问题：</p>
<p><img src="@source/posts/2018/assets/21943.png" alt="0"></p>
<p>这是一位读者遇到的问题，作者也是第一次遇到。为了解决该问题，作者请读者在电脑上安装了远程工具teamviewer：https://www.teamviewer.com/zhCN/</p>
<p>作者在这位读者的电脑上进行远程操作。解决方法是：</p>
<p>1）首先，将系统变量里的cygwin去掉</p>
<p>2）然后，如果是win7 32位系统，去这里https://sourceforge.net/projects/mingw/，下载Minimalist GNU for Windows，并安装之；如果是win7 64系统，去这里https://sourceforge.net/projects/mingw-w64，下载最新版本并安装。</p>
<p>3）安装以后，仍然是类似的方法，选择gcc-g++package安装</p>
<p><img src="@source/posts/2018/assets/21958.png" alt="0"></p>
<p>安装方法是选择后，再选择菜单里的apply change。选择后如下所示：</p>
<p><img src="@source/posts/2018/assets/21962.png" alt="0"></p>
<p>在终端里输入gcc --version，正常的输出：</p>
<p><img src="@source/posts/2018/assets/21965.png" alt="0"></p>
</div></template>
