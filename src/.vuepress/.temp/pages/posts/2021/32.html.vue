...
<h2 id="程序员如何用技术变现-上" tabindex="-1"><a class="header-anchor" href="#程序员如何用技术变现-上"><span>| 程序员如何用技术变现（上）</span></a></h2>
...
<h2 id="程序员如何用技术变现-下" tabindex="-1"><a class="header-anchor" href="#程序员如何用技术变现-下"><span>| 程序员如何用技术变现（下）</span></a></h2>
...
<h2 id="equifax信息泄露始末" tabindex="-1"><a class="header-anchor" href="#equifax信息泄露始末"><span>| Equifax信息泄露始末</span></a></h2>
...
<h2 id="从equifax信息泄露看数据安全" tabindex="-1"><a class="header-anchor" href="#从equifax信息泄露看数据安全"><span>| 从Equifax信息泄露看数据安全</span></a></h2>
...
<h2 id="何为技术领导力-06-如何才能拥有技术领导力" tabindex="-1"><a class="header-anchor" href="#何为技术领导力-06-如何才能拥有技术领导力"><span>| 何为技术领导力？&amp; 06 | 如何才能拥有技术领导力？</span></a></h2>
...
<h2 id="推荐阅读-每个程序员都该知道的知识" tabindex="-1"><a class="header-anchor" href="#推荐阅读-每个程序员都该知道的知识"><span>| 推荐阅读：每个程序员都该知道的知识</span></a></h2>
...
<h2 id="go语言-docker和新技术" tabindex="-1"><a class="header-anchor" href="#go语言-docker和新技术"><span>| Go语言，Docker和新技术</span></a></h2>
...
<h2 id="答疑解惑-渴望、热情和选择" tabindex="-1"><a class="header-anchor" href="#答疑解惑-渴望、热情和选择"><span>| 答疑解惑：渴望、热情和选择</span></a></h2>
...
<h2 id="如何成为一个大家愿意追随的leader" tabindex="-1"><a class="header-anchor" href="#如何成为一个大家愿意追随的leader"><span>| 如何成为一个大家愿意追随的Leader？</span></a></h2>
...
<h2 id="程序中的错误处理-错误返回码和异常捕捉-12-异步编程以及我的最佳实践⭐️" tabindex="-1"><a class="header-anchor" href="#程序中的错误处理-错误返回码和异常捕捉-12-异步编程以及我的最佳实践⭐️"><span>| 程序中的错误处理：错误返回码和异常捕捉 &amp; 12 | 异步编程以及我的最佳实践⭐️</span></a></h2>
...
<div class="language-js line-numbers-mode" data-ext="js" data-title="js"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">let</span><span class="space"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">res</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">await</span><span class="space"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">http</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665">request</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">url</span><span style="--shiki-light:#999999;--shiki-dark:#666666">,</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">data</span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">内含网络不佳、服务器打盹等情况下自动3次重试机制</span></span>
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">if</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">res</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">&#x26;&#x26;</span><span class="space"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">res</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">errMsg</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">===</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">‘</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">ok</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">‘</span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">{</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">...</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">}</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">else</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">{</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">...</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">}</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="魔数-0x5f3759df" tabindex="-1"><a class="header-anchor" href="#魔数-0x5f3759df"><span>| 魔数 0x5f3759df</span></a></h2>
...
<div class="language-c line-numbers-mode" data-ext="c" data-title="c"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">float</span><span class="space"> </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665">Q_rsqrt</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">float</span><span class="space"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">number</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">{</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">long</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">i</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">float</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">x2</span><span style="--shiki-light:#999999;--shiki-dark:#666666">,</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">const</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">float</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">threehalfs</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#2F798A;--shiki-dark:#4C9A91">1.5</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">F</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">x2</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">number</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#2F798A;--shiki-dark:#4C9A91">0.5</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">F</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">number</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">i</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">long</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">&#x26;</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">evil</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">floating</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">point</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">bit</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">level</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">hacking</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">i</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">0x</span><span style="--shiki-light:#2F798A;--shiki-dark:#4C9A91">5f3759df</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">-</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">i</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">>></span><span class="space"> </span><span style="--shiki-light:#2F798A;--shiki-dark:#4C9A91">1</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">);</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">what</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">the</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">fuck?</span><span class="space"> </span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">float</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">&#x26;</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">i</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">=</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">threehalfs</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">-</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">x2</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">*</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">)</span><span class="space"> </span><span style="--shiki-light:#999999;--shiki-dark:#666666">);</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">1st</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">iteration</span><span class="space"> </span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">2nd</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">iteration,</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">this</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">can</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">be</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">removed</span></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">//</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">y</span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">=</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">y</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">*</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">(</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">threehalfs</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">-</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">(</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">x2</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">*</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">y</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">*</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">y</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">)</span><span class="space"> </span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">);</span><span class="space"> </span></span>
<span class="line"></span>
<span class="line"><span class="space"> </span><span class="space"> </span><span class="space"> </span><span class="space"> </span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">return</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">y</span><span style="--shiki-light:#999999;--shiki-dark:#666666">;</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">}</span></span></code></pre>
...
<h2 id="推荐阅读-机器学习101" tabindex="-1"><a class="header-anchor" href="#推荐阅读-机器学习101"><span>| 推荐阅读：机器学习101</span></a></h2>
...
<h2 id="时间管理-同扭曲时间的事儿抗争-16-如何利用好自己的时间" tabindex="-1"><a class="header-anchor" href="#时间管理-同扭曲时间的事儿抗争-16-如何利用好自己的时间"><span>| 时间管理：同扭曲时间的事儿抗争 &amp; 16 | 如何利用好自己的时间？</span></a></h2>
...
<div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span>//</span><span class="space"> </span><span>下面这首诗识别率就很高</span></span>
<span class="line"><span>床前明月光，疑是地上霜。</span></span>
<span class="line"><span>举头望明月，低头思故乡。</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>遗憾的是，讯飞一直不支持五笔输入，我使用讯飞语音识别的时候，还必须在它和一个五笔输入法之间做频繁切换，这一点很不爽。工具是不断变化的，相信以后会有更好的工具。</p>
<p>以上就是我学习这篇文章以后所有的感悟了，很多内容都是想到了，但是不一定能做到。关于时间管理，确实是一项值得我们不断修炼的技能。</p>
<p><mark>（第二段到这里结束）</mark></p>
<h2 id="故障处理最佳实践-应对故障-18-故障处理最佳实践-故障改进⭐️" tabindex="-1"><a class="header-anchor" href="#故障处理最佳实践-应对故障-18-故障处理最佳实践-故障改进⭐️"><span>| 故障处理最佳实践：应对故障 &amp; 18 | 故障处理最佳实践：故障改进⭐️</span></a></h2>
...
<h2 id="答疑解惑-我们应该能够识别的表象和本质" tabindex="-1"><a class="header-anchor" href="#答疑解惑-我们应该能够识别的表象和本质"><span>| 答疑解惑：我们应该能够识别的表象和本质</span></a></h2>
...
<h2 id="git协同工作流-你该怎么选" tabindex="-1"><a class="header-anchor" href="#git协同工作流-你该怎么选"><span>| Git协同工作流，你该怎么选？</span></a></h2>
...
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">clone</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">git@gitee.com:rxyk/git-test.git</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--depth=1</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>git clone将远程仓库代码拉取本地。depth参数用于控制拉取层次，在拉取一些历史悠久的老仓库时很有用。</p>
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">add</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">.</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">stash</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">output:</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">Saved</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">working</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">directory</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">and</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">index</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">state</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">WIP</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">on</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">master:</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">040d83b</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">Initial</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">commit</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当我们在本地写代码的时候，如果线上有个问题必须马上处理一下，而本地的代码还没有写完，还不能提交，这时候应该怎么办呢？git stash指令可以帮助我们将本地的修改，暂时藏匿至一个看不见的区域。</p>
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">checkout</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">-b</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">hotfix-0404</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965">...</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">add</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">.</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">添加所有新增或修改文件</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">commit</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">-m</span><span class="space"> </span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">...</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">指定提交消息，描述本次修改</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">push</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">origin</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">hotfix-0404</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">推送</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">pull</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">origin</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">master</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--rebase</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> </span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">output:</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">CONFLICT</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">(add/add):</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">Merge</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">conflict</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">in</span><span class="space"> </span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE">c.txt</span></span></code></pre>
...
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">add</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">c.txt</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">还可能有其它文件</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">rebase</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--continue</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">最后修改提交消息</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">push</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">origin</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">hotfix-0404</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">推送</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>rebase操作也可以用于在小组内同步代码。时不时同步一下代码，可以避免代码积攒太多不好处理。如果你对项目做了不小的重构修改，最好也及时通知其它组员更新。</p>
<p>分支代码处理完以后，接下来到主分支，开始合并分支代码：</p>
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">checkout</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">master</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">pull</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">origin</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">master</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--rebase</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">merge</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">hotfix-0404</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--no-ff</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在合并分支的时候，仍然有可能出现冲突。这时候也需要手动编辑所有冲突，完成后再执行：</p>
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">add</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">c.txt</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">or</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">others</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">merge</span><span class="space"> </span><span style="--shiki-light:#A65E2B;--shiki-dark:#C99076">--continue</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">//</span><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE"> </span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">push</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">origin</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">master</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个地方，使用merge指令的时候使用了一个参数<code v-pre>--no-ff</code>。如下图所示，使用这个参数的好处，在于主分支提交历史更加清爽，这有利于线上代码的回滚。</p>
...
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">git</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">stash</span><span class="space"> </span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">pop</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>使用stash指令将代码取出来继续编辑。有时候我们一不小心写错了分支，也可以使用stash指令将新增的代码暂存起来，然后新增一个分支，再将暂时的代码恢复在新分支上，这样也是可以的。</p>
