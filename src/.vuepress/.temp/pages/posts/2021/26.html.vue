...
<h3 id="自己制定的计划自己买单" tabindex="-1"><a class="header-anchor" href="#自己制定的计划自己买单"><span>自己制定的计划自己买单</span></a></h3>
...
<h3 id="在源码管理上的经验总结" tabindex="-1"><a class="header-anchor" href="#在源码管理上的经验总结"><span>在源码管理上的经验总结</span></a></h3>
...
<p>每节课下面都有一个源码下载链接，如果想了解某节课对应的源码，直接从这个精选留言下载就可以了。</p>
<h3 id="学习是一个不断自我否定的过程" tabindex="-1"><a class="header-anchor" href="#学习是一个不断自我否定的过程"><span>学习是一个不断自我否定的过程</span></a></h3>
...
<h3 id="一体化的electron学习环境" tabindex="-1"><a class="header-anchor" href="#一体化的electron学习环境"><span>一体化的Electron学习环境</span></a></h3>
...
<p><code v-pre>git checkout $num</code></p>
...
<p>后记：</p>
<blockquote>
<p>昨天只算小忙。我有一次周未录课，因为那一周特别忙，白天一直给学生上课，根本没时间备课，周五晚上备课到第二天早上5点多，简单吃个早点，就打车去录音棚了。
