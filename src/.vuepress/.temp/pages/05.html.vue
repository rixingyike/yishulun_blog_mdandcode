<template><div><figure><img src="@source/posts/2023/assets/23cbde35-b859-41b5-9480-98b88bf40c44.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/posts/2023/assets/image-20230923115301691.png" alt="image-20230923115301691" tabindex="0" loading="lazy"><figcaption>image-20230923115301691</figcaption></figure>
...
<p>参考</p>
<ul>
<li><a href="https://bun.sh/blog/bun-v1.0" target="_blank" rel="noopener noreferrer">https://bun.sh/blog/bun-v1.0</a></li>
<li><a href="https://bun.sh/docs/installation#macos-and-linux" target="_blank" rel="noopener noreferrer">https://bun.sh/docs/installation#macos-and-linux</a></li>
</ul>
</div></template>
...
<h2 id="_6-如何向xmllist中推入一个元素" tabindex="-1"><a class="header-anchor" href="#_6-如何向xmllist中推入一个元素"><span>6，如何向XMLList中推入一个元素</span></a></h2>
<p>简单，使用加号：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-如何从xmllist中删除一个元素" tabindex="-1"><a class="header-anchor" href="#_7-如何从xmllist中删除一个元素"><span>7，如何从XMLList中删除一个元素</span></a></h2>
<p>删除不能使用减号(why?)，须使用delete关键字：</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>delete items.(@id == 1)[0];</span></span>
<span class="line"><span>delete不能作用于XMLList对象，操作对象必须是XML。</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-如何在xmllist中指定位置插入xml" tabindex="-1"><a class="header-anchor" href="#_8-如何在xmllist中指定位置插入xml"><span>8，如何在XMLList中指定位置插入XML</span></a></h2>
<p>先把XMLList包装为XML，然后使用XML的appendChild，prependChild，insertChildAfter，insertChildBefore方法实现。</p>
<h2 id="_9-如何获取子子节点列表或属性列表" tabindex="-1"><a class="header-anchor" href="#_9-如何获取子子节点列表或属性列表"><span>9，如何获取子子节点列表或属性列表</span></a></h2>
