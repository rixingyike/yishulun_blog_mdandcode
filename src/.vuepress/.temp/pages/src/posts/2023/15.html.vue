<template><div><figure><img src="@source/src/posts/2023/assets/image-20231027121250938.png" alt="简易篆刻刀法" tabindex="0" loading="lazy"><figcaption>简易篆刻刀法</figcaption></figure>
<h1 id="篆刻简易刀法总结-包括刻印面与刻边款的刀" tabindex="-1"><a class="header-anchor" href="#篆刻简易刀法总结-包括刻印面与刻边款的刀"><span>篆刻简易刀法总结，包括刻印面与刻边款的刀</span></a></h1>
<blockquote>
...
<h2 id="始终刻上边沿的简易刀法" tabindex="-1"><a class="header-anchor" href="#始终刻上边沿的简易刀法"><span>始终刻上边沿的简易刀法</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/image-20231027124854544.png" alt="image-20231027124854544" tabindex="0" loading="lazy"><figcaption>image-20231027124854544</figcaption></figure>
<p>朱文刻法类似，也是一直刻上边沿。如下图所示，中间的红色部分是要保留在印面上的，围绕着这个笔画顺时针走一圈，笔画也就完成了。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231027124946294.png" alt="image-20231027124946294" tabindex="0" loading="lazy"><figcaption>image-20231027124946294</figcaption></figure>
<p>上面的上边沿刻法，不分冲与切————无论冲刀与切刀，都是沿沟画的上边沿刻制。且在冲刀时，始终使用的是刻刀的内刀角。</p>
<p>这里出现了三个概念：冲、切、内刀角，可能有读者不明白，下面分别解释一下。</p>
<h2 id="冲刀、切刀、内外刀角的概念" tabindex="-1"><a class="header-anchor" href="#冲刀、切刀、内外刀角的概念"><span>冲刀、切刀、内外刀角的概念</span></a></h2>
<p>如下图所示，左侧即是冲刀。由于图是二维的，没有办法展示立体；如果是视频，我们应该同时能看到，刻刀着印的点是刻刀的内刀角。</p>
<p>右侧是切刀。切刀也是内刀角先着印面，然后用力向前压。</p>
<figure><img src="@source/src/posts/2023/assets/F9XvG6oagAA7yT_.png" alt="Image" tabindex="0" loading="lazy"><figcaption>Image</figcaption></figure>
<p>下面再解释内、外刀角。</p>
<p>对于刻刀，无论是右手持刀，还是左手持刀，一般情况下都是在胸前平放、倾斜的状态，刻刀的两个刀角有一个是离我们身体近的，另一个是稍远的。近的便是内刀角，远的便是外刀角。</p>
<p>在简刀刀法中，在刻印的时候，我们可以始终使用内刀角刻印。</p>
<h2 id="锥画沙、屋漏痕之毛边效果" tabindex="-1"><a class="header-anchor" href="#锥画沙、屋漏痕之毛边效果"><span>锥画沙、屋漏痕之毛边效果</span></a></h2>
<p>下面说一下毛边效果是怎么产生的。</p>
<p>这种效果在齐白石大师的白文印，或吴昌硕大师的朱文印里都经常能看到。基本上是一种一边齐、一边毛的感觉。</p>
<figure><img src="@source/src/posts/2023/assets/F9Xw_fEbIAADTWd.png" alt="Image" tabindex="0" loading="lazy"><figcaption>Image</figcaption></figure>
...
<figure><img src="@source/src/posts/2023/assets/F9XyNMfbAAAL3IW.png" alt="Image" tabindex="0" loading="lazy"><figcaption>Image</figcaption></figure>
<p>非独上边沿、下边沿的规定可以打破，内外边角的规定也可以打破。还是那句话，在大师眼里，着实是没有什么规矩的。</p>
<p>我们始终使用内边角刻印，是在刻印面时的一般规定，在刻边款时，有时候便需要使用外边角了。</p>
<h2 id="如何刻边款" tabindex="-1"><a class="header-anchor" href="#如何刻边款"><span>如何刻边款？</span></a></h2>
<p>边款的刻制，刀法并不算复杂，在冲与切的总刀法基础之上，只要练会基本的点、横、撇、竖、捺、转折、浮鹅钩，所有的字都会刻了。</p>
<p>下面分别看这几种基本的笔画如何刻制。</p>
<h3 id="_1-边款笔画点的刻制" tabindex="-1"><a class="header-anchor" href="#_1-边款笔画点的刻制"><span>1）边款笔画点的刻制</span></a></h3>
<p>分两种，如下图所示，左侧是内刀角向上冲，右侧是外刀角向上冲。两种都可以，具体在实践中用哪种，取决于篆法、章法的需要，以及篆刻者的心意。</p>
<figure><img src="@source/src/posts/2023/assets/F9X1MxKaYAAH1Pb.jpeg" alt="点" tabindex="0" loading="lazy"><figcaption>点</figcaption></figure>
<h3 id="_2-横的刻制" tabindex="-1"><a class="header-anchor" href="#_2-横的刻制"><span>2）横的刻制</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9X1iV8bsAA_DK4.png" alt="横" tabindex="0" loading="lazy"><figcaption>横</figcaption></figure>
<h3 id="_3-撇的刻制" tabindex="-1"><a class="header-anchor" href="#_3-撇的刻制"><span>3）撇的刻制</span></a></h3>
<p>在边款中，撇有两种，第一种其实是提，有短的、有长的。刻的时候，是内刀角入印，从左下向右上方向切压。</p>
<p>第二种，是一种是自左下向右上冲，也是使用内边角。这种切法，在下面的横折笔画中也能看到。</p>
<figure><img src="@source/src/posts/2023/assets/F9X3AgHaYAAZe6R.png" alt="撇" tabindex="0" loading="lazy"><figcaption>撇</figcaption></figure>
<h3 id="_4-竖-与竖钩-的刻制" tabindex="-1"><a class="header-anchor" href="#_4-竖-与竖钩-的刻制"><span>4）竖（与竖钩）的刻制</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9acuekbUAAWr8o.jpeg" alt="竖与竖钩" tabindex="0" loading="lazy"><figcaption>竖与竖钩</figcaption></figure>
<h3 id="_5-捺的刻画" tabindex="-1"><a class="header-anchor" href="#_5-捺的刻画"><span>5）捺的刻画</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9aeerGasAA-wNo.jpeg" alt="捺" tabindex="0" loading="lazy"><figcaption>捺</figcaption></figure>
<h3 id="_6-横折的刻制-一" tabindex="-1"><a class="header-anchor" href="#_6-横折的刻制-一"><span>6）横折的刻制（一）</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9agaZIasAAs9Pd.jpeg" alt="横折一" tabindex="0" loading="lazy"><figcaption>横折一</figcaption></figure>
<h3 id="_7-横折的刻制-二" tabindex="-1"><a class="header-anchor" href="#_7-横折的刻制-二"><span>7）横折的刻制（二）</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9ah4_oa8AAYwhN.jpeg" alt="横折二" tabindex="0" loading="lazy"><figcaption>横折二</figcaption></figure>
<h3 id="_8-浮鹅钩" tabindex="-1"><a class="header-anchor" href="#_8-浮鹅钩"><span>8）浮鹅钩</span></a></h3>
...
<figure><img src="@source/src/posts/2023/assets/F9ajpFrb0AADgg7.jpeg" alt="浮鹅钩" tabindex="0" loading="lazy"><figcaption>浮鹅钩</figcaption></figure>
...
<h2 id="现场演示补充" tabindex="-1"><a class="header-anchor" href="#现场演示补充"><span>现场演示补充</span></a></h2>
