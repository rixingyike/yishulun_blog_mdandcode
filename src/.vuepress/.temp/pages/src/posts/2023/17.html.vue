<template><div><h1 id="篆刻刻刀如何选择-不要选择哪些刻刀" tabindex="-1"><a class="header-anchor" href="#篆刻刻刀如何选择-不要选择哪些刻刀"><span>篆刻刻刀如何选择？不要选择哪些刻刀？</span></a></h1>
<p>篆刻刻刀都是平刃刀，没有选择尖角或斜角的，因为篆刻是用 90 度的刀角刻印的，并不是用刀尖刻印的。</p>
<p>在了解如何选择刻刀之前，我们需要先细致看一下篆刻的分类。明确了以下这些分类，及不同分类的优缺点，才能彻底明白如何选择。</p>
<h2 id="依平刃宽度划分类别" tabindex="-1"><a class="header-anchor" href="#依平刃宽度划分类别"><span>依平刃宽度划分类别</span></a></h2>
...
<h2 id="以刀刃材质划分类别" tabindex="-1"><a class="header-anchor" href="#以刀刃材质划分类别"><span>以刀刃材质划分类别</span></a></h2>
...
<h2 id="以开刃角度划分类别" tabindex="-1"><a class="header-anchor" href="#以开刃角度划分类别"><span>以开刃角度划分类别</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029180048282.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>这是一种很常见，也是某宝上最常见的钨钢合金刻刀，杆身长约16cm。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029175940215.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>开刃角度是 40 度，刃角看起来是钝钝的感觉。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029180217292.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>这是纳米刻刀。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029180305795.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>它的开刃角度也是 40 度。</p>
<p>关于开刃角度，如果不确定多少，可以用中学生用的量角器量一下，虽然量得不精确，但大概也能量出是多少度。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029180452677.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>这是西泠印社出品的一套双坡度钨钢合金刻刀，上面那把是 6mm 的，下面那把是 8mm 的。这套刻刀初看无敌，可惜做工不太精细，刃开的也不是很光滑，顶端方杆也不圆润，十分硌手。价格也略高。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029180625027.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>它们的开刃角度是 30 度。这种刻刀是双坡度，我们能看到它的刀刃坡度分了前后两级，我们说的开刃角度是与与刀刃最近的那个角度。这种 30 度刃角的双坡度刻刀，其实是优于单坡度 30 度刃角的刻刀的。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029180921837.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>这是双坡度白钢刻刀，刃宽 10mm。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029181005665.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>它的开刃角度也是 30 度，但价格比钨钢材质的便宜。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029181047296.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>上面这把不是刻刀！它本是光杆的，被探长绕上了一层绒绳。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029182154058.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>上面这些，它们是开山凿碑的钢钎！黄色部分是黄铜，上面的钎杆是白钢，下面的刀刃材质是钨钢。因为钨钢贵，白钢相对便宜，所以中间临近钎头的部分使用黄铜焊接了一下。这种钢钎杆身长达 21cm，而普通的篆刻刀杆身通常只有 16cm。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029182942617.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>由于它是凿石碑的，它的开刃角度竟然有 50 度。只有开刃角度大，在凿石碑的时候才不容易崩刃。这种钢钎是不合适直接刻印的。</p>
<p>有人给探长寄了几把钎子，我把其中 8mm 的一把用金刚磨盘开了刃，如下所示，猜猜它的角度是多少？</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029185810964.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>23 度！刚刚好！</p>
<p>然后我还给它缠了一层牛皮绳·：</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029190156981.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
...
<h2 id="吴昌硕与齐白石的刻刀" tabindex="-1"><a class="header-anchor" href="#吴昌硕与齐白石的刻刀"><span>吴昌硕与齐白石的刻刀</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029193915002.png" alt="吴昌硕刻刀仿制" tabindex="0" loading="lazy"><figcaption>吴昌硕刻刀仿制</figcaption></figure>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029195539946.png" alt="修脚刀" tabindex="0" loading="lazy"><figcaption>修脚刀</figcaption></figure>
<p>齐白石大师在治印时擅用单刀冲刻，这种刀法要求刻刀的刀刃绝不能厚，厚了便很难冲刻时爽利，也很难崩出毛边效果。</p>
<h2 id="我们如何选择刻刀" tabindex="-1"><a class="header-anchor" href="#我们如何选择刻刀"><span>我们如何选择刻刀？</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029200653509.png" alt="刻刀" tabindex="0" loading="lazy"><figcaption>刻刀</figcaption></figure>
<p>第二种选择是铜杆钨钢篆刻刀套装。</p>
<p>有多家店铺可以选择，包括 10mm、8mm、6mm 三把，刃角 30 度。价格在 200 左右。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029200916309.png" alt="双坡度刻刀" tabindex="0" loading="lazy"><figcaption>双坡度刻刀</figcaption></figure>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029201907115.png" alt="双坡度刻刀" tabindex="0" loading="lazy"><figcaption>双坡度刻刀</figcaption></figure>
<p>匠人自制由于没有品牌溢价，价格上都比大店铺便宜。</p>
<p>下面这种刃角仅 10 度的平头 10mm 宽刀，价格仅 40 左右。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029205815252.png" alt="10mm刻刀" tabindex="0" loading="lazy"><figcaption>10mm刻刀</figcaption></figure>
<p>下面是 8mm 的薄刃刻刀，价格与 10mm 的差不多。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029202642650.png" alt="8mm刻刀" tabindex="0" loading="lazy"><figcaption>8mm刻刀</figcaption></figure>
<h2 id="不要选择什么样的刻刀" tabindex="-1"><a class="header-anchor" href="#不要选择什么样的刻刀"><span>不要选择什么样的刻刀？</span></a></h2>
<p>下面说一下哪些篆刻刀不要选择。</p>
<p>首先，圆头刻刀不要选择！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029202809762.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>刻刀治印用的是刀角，圆角刻刀没有刀角怎么刻印？</p>
<p>刃面不平的不要选择！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029202915256.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>刻刀如果需要磨制，不平的或有弧度的刃面并不方便固定角度。此处，从加重刻刀刀身的稳定性考虑，也不合适在刀头上减少重量。</p>
<p>不要迷信套装型号齐全！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029203123778.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>篆刻刀只需要双平头、双面对称的刻刀，什么单平头、单斜头、圆尖头统统不需要。型号再全也没有用，上架这种商品的一看就是不懂篆刻的商家，买家也只能是不懂篆刻的初学者。</p>
<p>太软材质的，兼具木刻功能的刻刀，尤其是木柄刻刀不要选择！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029203407361.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>锰钢材质的刻刀是软质刻刀，一般也不要选择。至少选择白钢，优先选择钨钢材质的。</p>
<p>进口的、价格太贵的不要买！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029203639878.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>刻刀材质无非就是那几种，基本的白钢材质就能满足需求，国外的月亮并不比国内的更圆。在选择时，关键是刃角与刻刀的舒服度、顺手度，加个“进口”二字就多付上百块没有必要。</p>
<p>太贵的手工锻打刻刀，也没有必要购买！</p>
<figure><img src="@source/src/posts/2023/assets/image-20231029204108318.png" alt="不要购买的刻刀" tabindex="0" loading="lazy"><figcaption>不要购买的刻刀</figcaption></figure>
<p>这类刻刀，完全可以购买 14 块钱的钨钢钎子，外加 5 块钱的金刚磨盘和两个小时的时间，自己磨制一把缶翁遗响仿制刻刀。</p>
<h2 id="如何自己磨制刻刀" tabindex="-1"><a class="header-anchor" href="#如何自己磨制刻刀"><span>如何自己磨制刻刀？</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/image-20231029204820333.png" alt="金刚磨盘与定角器" tabindex="0" loading="lazy"><figcaption>金刚磨盘与定角器</figcaption></figure>
...
<h2 id="_10-30补充-章料的选择" tabindex="-1"><a class="header-anchor" href="#_10-30补充-章料的选择"><span>10/30补充，章料的选择</span></a></h2>
<p>附一张刻刀与常见章料的硬度对比图：</p>
<figure><img src="@source/src/posts/2023/assets/image-20231030143719609.png" alt="image-20231030143719609" tabindex="0" loading="lazy"><figcaption>image-20231030143719609</figcaption></figure>
