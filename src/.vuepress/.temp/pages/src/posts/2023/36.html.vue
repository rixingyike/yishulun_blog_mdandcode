...
<figure><img src="@source/src/posts/2023/assets/F-jfFBJWAAAoHwP.jpeg" alt="MyGPT" tabindex="0" loading="lazy"><figcaption>MyGPT</figcaption></figure>
...
<h2 id="chatgpt-帐号注册" tabindex="-1"><a class="header-anchor" href="#chatgpt-帐号注册"><span>ChatGPT 帐号注册</span></a></h2>
...
<h2 id="plus-会员购买" tabindex="-1"><a class="header-anchor" href="#plus-会员购买"><span>Plus 会员购买</span></a></h2>
...
<h2 id="七步创建自己的-gpt" tabindex="-1"><a class="header-anchor" href="#七步创建自己的-gpt"><span>七步创建自己的 GPT</span></a></h2>
...
<figure><img src="@source/src/posts/2023/assets/efb466c410f6afb3cdbf37a90fbfc6c.png" alt="My GPTs" tabindex="0" loading="lazy"><figcaption>My GPTs</figcaption></figure>
<p>第一步，选择创建按钮。</p>
<p>第二步，开始创建。</p>
...
<figure><img src="@source/src/posts/2023/assets/image-20231110223101946.png" alt="configure" tabindex="0" loading="lazy"><figcaption>configure</figcaption></figure>
<p>第四步，设置起始提示语。</p>
<p>在 Configure 页面还可以设置起始提示，例如下面截图中贴近下方输入框的那 4 句便是。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231110223447314.png" alt="起始提示语" tabindex="0" loading="lazy"><figcaption>起始提示语</figcaption></figure>
<p>在 Configure 页面，有一个 Actions 设置，这是对外部第三方服务的调用设置，可以调用自己的网站 API。它并不是预置的提示，如果设置预置提示，在前面的起始提示处设置。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231110223617423.png" alt="Actions" tabindex="0" loading="lazy"><figcaption>Actions</figcaption></figure>
<p>第五步，上传文件。</p>
<p>可以在 Configure 页面上传，也可以互动输入框上传。我是在输入框上传的，上传的同时又输入了一些提示，要求 ChatGPT 学习和理解这些十分重要的文件。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231110223905299.png" alt="知识文件" tabindex="0" loading="lazy"><figcaption>知识文件</figcaption></figure>
<p>第六步，测试与预览。</p>
<p>整个创建 GPT 的页面分为左右两个区域，前面我们一直在左面这个区域操作，现在 GPT 的创建基本完成了，我们可以在右面这个区域测试和预览它的功能表现了。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231110224231228.png" alt="Story Weaver" tabindex="0" loading="lazy"><figcaption>Story Weaver</figcaption></figure>
<p>第七步，保存。</p>
<p>更新按钮在右上角，在保存时，可以保存为私有、获得链接者可用或公开。这个范围选项，包含前面的 GPT 的 Configure 设置，都不是一次性的，过后都可以重新编辑。</p>
<figure><img src="@source/src/posts/2023/assets/image-20231110224506012.png" alt="保存" tabindex="0" loading="lazy"><figcaption>保存</figcaption></figure>
