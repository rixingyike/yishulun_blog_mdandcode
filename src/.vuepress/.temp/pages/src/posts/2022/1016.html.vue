<template><div><h1 id="使用面向过程和面向对象结合的思想开发软件" tabindex="-1"><a class="header-anchor" href="#使用面向过程和面向对象结合的思想开发软件"><span>使用面向过程和面向对象结合的思想开发软件</span></a></h1>
<p>两者结合起来，开发更有保障。</p>
...
<p>第一步系统分析，产出数据流图。</p>
<figure><img src="@source/src/posts/2022/assets/image-20221016214506449.png" alt="image-20221016214506449" tabindex="0" loading="lazy"><figcaption>image-20221016214506449</figcaption></figure>
<p>第二步系统设计，产出系统结构图。在这一步里，确定了模块划分，其中输入、输出和选择加密方式这三个都是 UI 模块，RSA 和 AES 是算法模块。</p>
<figure><img src="@source/src/posts/2022/assets/image-20221016214813037.png" alt="image-20221016214813037" tabindex="0" loading="lazy"><figcaption>image-20221016214813037</figcaption></figure>
