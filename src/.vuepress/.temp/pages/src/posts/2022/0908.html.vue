<template><div><h1 id="从金庸小说和齐白石国画-看网文如何加快节奏" tabindex="-1"><a class="header-anchor" href="#从金庸小说和齐白石国画-看网文如何加快节奏"><span>从金庸小说和齐白石国画，看网文如何加快节奏？</span></a></h1>
...
<!--more-->
<h2 id="武侠小说中文字的疏与密" tabindex="-1"><a class="header-anchor" href="#武侠小说中文字的疏与密"><span>武侠小说中文字的疏与密</span></a></h2>
...
<h2 id="国画中的写意与写实" tabindex="-1"><a class="header-anchor" href="#国画中的写意与写实"><span>国画中的写意与写实</span></a></h2>
<p>下面看国画中的写意。什么是写意？说白了就是「疏」，就是「略」，就是抽象。这是一张齐白石的草虫国画：</p>
<figure><img src="@source/src/posts/2022/assets/d452cdc9b65840a89bc1aeaff04516c0.jpeg" alt="齐白石画作" tabindex="0" loading="lazy"><figcaption>齐白石画作</figcaption></figure>
