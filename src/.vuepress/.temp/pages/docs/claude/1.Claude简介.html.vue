...
<figure><img src="@source/docs/claude/assets/image-20230728085828815.png" alt="图：slack的频道" tabindex="0" loading="lazy"><figcaption>图：slack的频道</figcaption></figure>
<p>在 stack 上，这里的频道更像是一种数据的展示方式，像“全体”频道，它其实也包括其它公开频道中的内容。</p>
<p>根据我自己的实践，Claude 与 ChatGPT 的上下文窗口都是这样的：</p>
<figure><img src="@source/docs/claude/assets/image-20230728085449424.png" alt="图：多会话线程上下文窗口" tabindex="0" loading="lazy"><figcaption>图：多会话线程上下文窗口</figcaption></figure>
