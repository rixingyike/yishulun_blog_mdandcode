<template><div><h1 id="_4-高效提示的-5-个方式" tabindex="-1"><a class="header-anchor" href="#_4-高效提示的-5-个方式"><span>4. 高效提示的 5 个方式</span></a></h1>
<p>提问的质量决定了 AI 回答的质量。以下是五个高效提问的方式技巧：</p>
<h2 id="_1-在两点之间让-ai-明确自己的需求" tabindex="-1"><a class="header-anchor" href="#_1-在两点之间让-ai-明确自己的需求"><span>1，在两点之间让 AI 明确自己的需求</span></a></h2>
<p>两点决定一条线段。如果只告诉 AI 一点信息，它会 360 度发散，是很难输出有效信息的。</p>
<p>例如，如果我们想了解某软件 A 的使用技巧，我们不应该笼统地问：“软件 A 怎么用？”而应该更明确地问：“我该如何用软件 A 达到我的某某需求？”</p>
<h2 id="_2-提供尽可能详细的上下文信息" tabindex="-1"><a class="header-anchor" href="#_2-提供尽可能详细的上下文信息"><span>2，提供尽可能详细的上下文信息</span></a></h2>
...
<h2 id="_3-使用清晰且具体的词语" tabindex="-1"><a class="header-anchor" href="#_3-使用清晰且具体的词语"><span>3，使用清晰且具体的词语</span></a></h2>
...
<h2 id="_4-分范围、分阶段提问" tabindex="-1"><a class="header-anchor" href="#_4-分范围、分阶段提问"><span>4，分范围、分阶段提问</span></a></h2>
...
<div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span>1. **夏朝**（约前 2070 年 - 前 1600 年）</span></span>
...
<p>AI 的答案是：</p>
<div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span>"五代十国"是中国历史上从唐朝末期到北宋初年这段时期的统称，大约从 907 年到 960 年。"五代"指的是后梁、后唐、后晋、后汉和后周这五个在中原相继建立的短命王朝。"十国"则是指当时在江南和西南地区建立的十个较稳定的割据政权。</span></span>
...
<h2 id="_5-追问与澄清" tabindex="-1"><a class="header-anchor" href="#_5-追问与澄清"><span>5，追问与澄清</span></a></h2>
