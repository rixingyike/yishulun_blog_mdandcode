<template><div><h1 id="小说创作的最低要求是什么" tabindex="-1"><a class="header-anchor" href="#小说创作的最低要求是什么"><span>小说创作的最低要求是什么？</span></a></h1>
<p>对于程序而言，代码没有异常，可以正常运行，这是最低的要求。软件正常运行以后，才是用户体验上的考虑，考虑如何让用户用得更舒服。
