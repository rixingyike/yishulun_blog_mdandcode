<template><div><h1 id="二极管工作原理" tabindex="-1"><a class="header-anchor" href="#二极管工作原理"><span>二极管工作原理</span></a></h1>
<blockquote>
...
<!-- more -->
<h2 id="什么是半导体" tabindex="-1"><a class="header-anchor" href="#什么是半导体"><span>什么是半导体？</span></a></h2>
...
<h2 id="二极管的构成" tabindex="-1"><a class="header-anchor" href="#二极管的构成"><span>二极管的构成</span></a></h2>
<p>如下所示，一个经典的二极管从左到右由正极（导电金属）、P（Positive）型半导体材质区、PN 结、N（Negative）型半导体材质区和负极（导电金属）组成。</p>
<img src="@source/src/posts/2022/assets/image-20220913202855289.png" alt="image-20220913202855289" style="zoom: 50%;" />
<p>图 1</p>
...
<img src="@source/src/posts/2022/assets/image-20220913203330556.png" alt="image-20220913203330556" style="zoom:50%;" />
<p>图 2</p>
<h2 id="二极管的工作原理是什么" tabindex="-1"><a class="header-anchor" href="#二极管的工作原理是什么"><span>二极管的工作原理是什么？</span></a></h2>
<p>下面看二极管的工作原理。</p>
...
<p>下面我们看二极管。</p>
<img src="@source/src/posts/2022/assets/image-20220913205202322.png" alt="image-20220913205202322" style="zoom: 15%;" />
<p>图 3</p>
...
<img src="@source/src/posts/2022/assets/image-20220913210031426.png" alt="image-20220913210031426" style="zoom:33%;" />
<p>图 4</p>
...
<img src="@source/src/posts/2022/assets/image-20220913210521056.png" alt="image-20220913210521056" style="zoom:25%;" />
<p>图 5</p>
...
<h3 id="正向偏置和反向偏置" tabindex="-1"><a class="header-anchor" href="#正向偏置和反向偏置"><span>正向偏置和反向偏置</span></a></h3>
<p>正向偏置和反向偏置这两个概念很容易混淆，我们只需要记住二极管在正向偏置下是导电的就可以了。如下所示，这是正向偏置的示意图。</p>
<img src="@source/src/posts/2022/assets/image-20220913212544942.png" alt="image-20220913212544942" style="zoom:33%;" />
<p>图 6</p>
...
<img src="@source/src/posts/2022/assets/image-20220913213507547.png" alt="image-20220913213507547" style="zoom:25%;" />
<p>图 7</p>
<h3 id="伏安特性曲线" tabindex="-1"><a class="header-anchor" href="#伏安特性曲线"><span>伏安特性曲线</span></a></h3>
<p>如果我们考察二极管中的电流大小，在正向偏置和反向偏置中的变化，可以得出一条伏安特性曲线，如下所示。</p>
<img src="@source/src/posts/2022/assets/image-20220913161058655.png" alt="image-20220913161058655" style="zoom:50%;" />
<p>图 8</p>
<p>在这条二维曲线中：</p>
<ul>
...
<h3 id="什么是二极管的击穿态" tabindex="-1"><a class="header-anchor" href="#什么是二极管的击穿态"><span>什么是二极管的击穿态？</span></a></h3>
...
<h2 id="电信号怎么转化为数字信号" tabindex="-1"><a class="header-anchor" href="#电信号怎么转化为数字信号"><span>电信号怎么转化为数字信号？</span></a></h2>
<p>二极管通电与不通电，其实是一个开关，是电信号。</p>
<p>有了二极管，就可以设计各种逻辑门电路了，例如与门电路：</p>
<img src="@source/src/posts/2022/assets/image-20220913215303022.png" alt="image-20220913215303022" style="zoom:33%;" />
<p>图 9</p>
<p>它由两个二极管组成，只有 A 与 B 同时都处于导通，也就是正向偏置的状态，L 端才有输出，否则没有输出。注意上方的 R 是一个电阻，电流是不会往这边跑的。</p>
<p>下面这个是或门电路：</p>
<img src="@source/src/posts/2022/assets/image-20220913215722311.png" alt="image-20220913215722311" style="zoom:33%;" />
<p>图 10</p>
...
<figure><img src="@source/src/posts/2022/assets/two-bit-adder-using-full-adder.png" alt="两位加法器, 使用全加器" tabindex="0" loading="lazy"><figcaption>两位加法器, 使用全加器</figcaption></figure>
<p>图 11</p>
...
<h3 id="数字信号在计算机内是如何暂存的" tabindex="-1"><a class="header-anchor" href="#数字信号在计算机内是如何暂存的"><span>数字信号在计算机内是如何暂存的？</span></a></h3>
...
<img src="@source/src/posts/2022/assets/image-20220913224100423.png" alt="image-20220913224100423" style="zoom:33%;" />
<p>图 12</p>
...
<h3 id="计算机内的高低电平是怎么产生的" tabindex="-1"><a class="header-anchor" href="#计算机内的高低电平是怎么产生的"><span>计算机内的高低电平是怎么产生的？</span></a></h3>
...
<h2 id="相关问题" tabindex="-1"><a class="header-anchor" href="#相关问题"><span>相关问题</span></a></h2>
<h3 id="二极管正负极如何判定" tabindex="-1"><a class="header-anchor" href="#二极管正负极如何判定"><span>二极管正负极如何判定？</span></a></h3>
<p>人类在生产的时候做了一些规定。</p>
<p>1）一般有色环的为负极，有白线的一端为负极。</p>
<figure><img src="@source/src/posts/2022/assets/1-1P3200914212Z.png" alt="二极管正负极" tabindex="0" loading="lazy"><figcaption>二极管正负极</figcaption></figure>
<p>图 13</p>
<p>2）对于发光二极管，引脚长的为正极，短的为负极。</p>
<figure><img src="@source/src/posts/2022/assets/1-1P32009144S10.png" alt="发光二极管正负极" tabindex="0" loading="lazy"><figcaption>发光二极管正负极</figcaption></figure>
<p>图 14</p>
<p>3）发光二极管管体内部金属极较小的是正极，大的片状的是负极。</p>
<figure><img src="@source/src/posts/2022/assets/1-1P320091610515.png" alt="二极管正负极判断" tabindex="0" loading="lazy"><figcaption>二极管正负极判断</figcaption></figure>
<p>图 15</p>
<p>4）看图示，竖杠一端为阴极（负极），三角一端为阳极（正极）。三角是一个箭头，箭头指向的方向是电流的方向，在电的一般定义中，电流与正电荷的方向一致（虽然没有正电荷，移动的只有反方向的带负电的电子）。</p>
<img src="@source/src/posts/2022/assets/image-20220914071136424.png" alt="image-20220914071136424" style="zoom:50%;" />
<p>图 16</p>
<h3 id="什么是二极管思维" tabindex="-1"><a class="header-anchor" href="#什么是二极管思维"><span>什么是二极管思维？</span></a></h3>
<p>是一个讽刺比喻。思想偏激，非黑即白，不能辩证地、客观地看待问题。看待事物的观点比较单一，自带立场，只认为与自己立场的观点是正确的，其他的都是错误的。没有独立人格和独立思维意识。</p>
<h2 id="送一张畅学卡" tabindex="-1"><a class="header-anchor" href="#送一张畅学卡"><span>送一张畅学卡</span></a></h2>
<p>最后，说一个与二极管无关的小事。中秋节的时候，极客时间送了我一些畅学卡，相当于是一个临时会员，可以免费学习上面的付费课程。还剩几张，如果对你有用，你想体验，私信我发给你。先到先得，发完为止。</p>
<img src="@source/src/posts/2022/assets/image-20220914072459721.png" alt="image-20220914072459721" style="zoom: 50%;" />
<p>图 17</p>
